...
1. Choose a Leader  
2. Followers choose their method of supporting and make a Test  
3. The Leader makes a Check to determine the group’s success, with modifiers from the Follower’s outcomes
...
* Scale 1 is what a normal person could accomplish with simple tools or luck.  
* Scale 2 is beyond what an unequipped person could accomplish purely with luck. Some sort of specialized Asset, magic, or fictional positioning is necessary.  
...
* Scale 4 is far beyond what a mundane human can accomplish and, even with highly specialized equipment, can only be achieved with luck. Even with magic, a protagonist must exert themselves to reach Scale 4\.  
* Scale 5 is the absolute apex of what can be accomplished by a protagonist. Scale 5 can be reached only with a combination of powerful magic and luck.

Examples of tasks at each Scale are provided later in the Skills Description section.

## **Scale Factors**

Scale is a composite of four underlying factors. The Scale of an Action or challenge may derive primarily from one of these factors or a combination of multiple. It is not important to assign an exact value to each of these, as they simply guide the referee to determining the overall Scale.

* **Potency.** How forceful, destructive, influential, or impactful the outcome is. Lifting a car has a higher Scale than lifting moving boxes due to the potency.  
* **Speed.** How rapidly the outcome can be achieved. Chasing down a car has a higher Scale than chasing down a culprit on foot due to speed.  
* **Duration.** How long the outcome lasts. Restraining a rampaging beast for an hour is higher Scale than doing so for a moment due to Duration.  
* **Scope.** The breadth of the outcome in terms of range, area of effect, or number of targets. Magically healing an entire group is higher Scale than doing so for an individual due to scope.

## **Required Scale**

An Action or Reaction cannot overcome a challenge with a higher Scale. For example, a Scale 0 unarmed strike cannot meaningfully harm a Scale 3 armored vehicle.

If a Scale gap makes an Action impossible, the referee should plainly state so instead of calling for a Check.

## **Critical Hit Scale Increase**

Whenever a protagonist scores a Critical Hit (gets a result of 20 or greater on a Check), they gain \+1 Scale on that Action. This bonus can apply only once per check and only to that specific attempt. This might allow the protagonist to achieve greater feats than typical due to luck.
...
* The protagonist rolls an additional d10 when determining the amount of points they earn towards a Counter (Potency).  
* The protagonist creates a Trait in addition to accomplishing their goal (Potency).  
* Additional targets are affected (Scope).  
* The task is accomplished faster than expected (Speed).  
* The referee skips using a Complication (Speed).  
* The effects of success are longer lasting or permanent instead of temporary (Duration).  
...
Counters are comprised of one to ten “slots”. Each slot is worth 5 points. Whenever points are assigned to a Counter, fill slots until no points remain. Even if only a single point remains, the entire slot must be filled. For example, if you gain 7 points towards a Counter, fill two slots.
...
Abilities are grouped into three categories \- Physical, Mental, and Emotional. These categories matter for certain features.
...
* **Empathy.** Sensitivity, compassion, and emotional insight.

## **Ability Ranks**

Each protagonist has a rank of 1 to 10 in each of the nine Abilities. Protagonists can increase their ranks in Abilities with Talents.

## **Ability Die**

An Ability’s rank determines the Ability die added to Checks that use that Ability:

| Ability Rank | Ability Die |
| :---- | :---- |
| 1 | d0 |
| 2-3 | d4 |
| 4-5 | d6 |
...
Each protagonist has three Effort pools:

* **Blood.** Tied to Physical Abilities (Might, Grace, Endurance)  
* **Sweat.** Tied to Mental Abilities (Intellect, Cunning, Will)  
* **Tears.** Tied to Emotional Abilities (Confidence, Guile, Empathy)

## **Spending Effort**

When a protagonist makes a Check, after seeing the result, they may spend up to 5 Effort from the pool associated with the Ability used for that check. For each point of Effort spent, the protagonist gains \+1 to that Check’s result.

## **Regaining and Refreshing Effort**

The maximum number of points a protagonist can have in each of their Effort pools is determined by the protagonist’s ranks in the associated Abilities. This number is referred to as their Refresh. For example, a protagonist with 5 ranks in Might, 4 ranks in Grace, and 2 ranks in Endurance has 11 Blood Refresh.

Protagonists regain Effort by compelling Skills, as described in the Skills section.
...
* **Mask.** How the protagonist presents themselves or how they are perceived. Masks reflect public identity, self-image, persona, and general reputation.  
* **Heart.** What the protagonist holds most dear or who they truly are, their passions and authentic self.  
* **Shadow.** The part of the protagonist that they hide or suppress: fears, resentment, inconvenient desire, weaknesses, or dangerous impulses.
...
* The protagonist gains one rank in an Affinity related to the goal of that Agenda. The Affinity may be chosen from any Affinity list except Conviction or Tendency.  
* The protagonist gains a new Anchor related to the Agenda.  
* The protagonist clears a Lingering Wound. Only choose this option if the Agenda was dedicated to clearing that Lingering Wound.
...
* Significant relationships with non-protagonist characters (platonic, familial, romantic, complicated, or antagonistic)  
* Membership in a club, workplace, team, community group, or gang.  
* Meaningful activities, hobbies, belief systems, or long-term commitments.
...
Each protagonist has a 10 slot Despair Counter. Whenever they suffer Despair, they must either absorb it with a combination of Despair and Moods.

## **Clearing Despair**

Filled Despair slots may be cleared in several ways. At a Major Milestone, each protagonist clears all filled Despair slots. At a Minor Milestone, a protagonist may spend any number of their Hope points to clear one Despair slot per point of Hope spent (no Action required).

In addition, a protagonist may use a Bolster Action to attempt to relieve the Despair of another protagonist. On a success, the protagonist clears filled slots worth up to 1d10 Despair.

## **Fragile State**

When a protagonist fills their fifth Despair slot, they become Fragile. While Fragile, the results of a protagonist’s successes are mitigated. Critical Hits become Hits, Hits become Grazes, and Grazes become Misses.

## **Broken State**

When a protagonist fills their tenth Despair slot, they become Broken. While Broken, a protagonist suffers three effects.

### **Greater Mitigation**

The protagonist’s successes are further mitigated. Critical Hits become Grazes and all other results become Misses.

### **Hopelessness**

The protagonist is unable to spend Hope for any purpose, including to clear Despair at Minor Milestones.

A Broken protagonist may be rescued by having an ally compel their Connection to the Broken protagonist and giving up the Hope they would receive. In exchange, the Broken protagonist clears 5 of their filled Despair slots.
...
Each protagonist has a Corruption Counter with 10 slots, each slot is worth 5 Corruption. Protagonists gain Corruption by using magic or by refusing Aspect compels.

## **Reducing Corruption**

Protagonists can reduce their Corruption by compelling an Anchor. Whenever a protagonist compels an Anchor, instead of regaining Hope, they may clear one Corruption slot.

## **Effects of Corruption**

Gaining Corruption has no impact during a session. Instead, it only begins to impact protagonists after Milestones.
...
The protagonist permanently loses one of their Anchors. At the next narrative opportunity, or via a Flashback, the referee and player reveal how that tie was destroyed. If a protagonist would lose the final Anchor in this way, they cannot choose this option.

### **Drain Memories**

The protagonist chooses five Memories from among their Aspects, Connections, or Agendas. They lose each chosen Memory. The protagonist cannot choose this option if they do not have at least five Memories amongst their Traits.

### **Dramatic Confrontation**

The protagonist’s Corruption erupts violently. The remaining protagonists face opposition with a 10-slot Progress Counter.

If the group overcomes this opposition, the Consumed protagonist is saved and their Temptation points are lost.

If the remaining protagonists yield or are Defeated, the Consumed protagonist must choose the Fall to Darkness option instead.
...
* **Upgrade Ability die.** The protagonist may upgrade the size of their Ability die for the check to match that of the Quality die for the Asset used.  
...
A Minor Milestone occurs at the end of every session. The referee may apply it immediately or at the start of the next session.

At a Minor Milestone, each protagonist does the follow:

1. Refresh Affinity free invokes  
2. Attempt to heal one Wound by making a Recovery Test  
3. Spend Hope to clear Despair  
...
A Major Milestone occurs at the end of the last session in a story arc, as determined by the referee. A Major Milestone typically occurs every 3-5 sessions. At a Major Milestone, each protagonist benefits from a Minor Milestone and then:
...
Talents increase protagonist Ability ranks. When a Talent is placed into a slot for a Skill, they increase their rank in the Ability associated with that Skill by 1 (to a maximum of 10).
...
* **Referee.** The person who narrates the consequences of protagonist actions and adjudicates the rules.  
* **Player.** Anyone playing the game besides the referee.  
* **Protagonist.** A character controlled by a player.  
* **Non-protagonist Character (NPC).** A character controlled by the referee.  
* **Invoke.** When a game element (such as a Trait) is activated to produce an effect  
* **Compel.** When a game element can potentially create difficulty for a protagonist, that element can be compelled to cause that difficulty in exchange for some benefit.  
