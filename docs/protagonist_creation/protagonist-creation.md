...
For each other protagonist, you gain a Neutral Connection. You then gain Memories for that Connection depending on your and the other protagonist’s Compatibility Element, as shown in the following table. Describe the Connection.

|  |  | Their Element |  |  |  |
| :---- | :---- | ----- | :---- | :---- | :---- |
|  |  | **Fire** | **Water** | **Earth** | **Air** |
| **Your Element** | **Fire** | One Positive Memory, One Neutral Memory | Two Negative Memories | One Negative Memory, One Neutral Memory | Two Positive Memory |
|  | **Water** | Two Negative Memories | One Positive Memory, One Neutral Memory | Two Positive Memories | One Negative Memory, One Neutral Memory |
|  | **Earth** | One Negative Memory, One Neutral Memory | Two Positive Memories | One Positive Memory, One Neutral Memory | Two Negative Memories |
|  | **Air** | Two Positive Memories | One Negative Memory, One Neutral Memory | Two Negative Memories | One Positive Memory, One Neutral Memory |
...
* Distribute 100 SP  
* Cannot increase Skill rank beyond 6 using this SP  
* Lose any unspent SP
...
* **Tome.** Your Relic takes the form of something you harness to draw power, such as a book, gem, scroll, or collection of cards. You gain \+1 rank to Intellect, Cunning, and Will.

* **Familiar.** Your Relic takes the form of something you consult to harness power, such as a spirit, animated object, magical creature, or unseen entity. You gain \+1 rank to Confidence, Guile, and Empathy.
...
* The first rank in an Affinity costs additional Mana of the type listed next to that Affinity in the list.  
...
Taking turns, each protagonist chooses one Regalia Feature that has not yet been chosen yet by another protagonist. All protagonists gain that benefit for as long as that protagonist remains in the group.

* Wingless Ascension. Can move in three dimensions  
* Wordless Whispers. Can communicate with others telepathically  
* Hollow Space. Can store and retrieve objects  
* Faceless Mask. Anonymous while transformed  
* Sacrosanct Flesh. Can’t suffer Wounds while transformed (can still be Broken)  
* Eyeless Sight. Know when evil is nearby  
* Hidden Palace. Have a hideout and base you can retreat to
